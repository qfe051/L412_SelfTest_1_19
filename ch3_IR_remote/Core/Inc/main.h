...
#define IR_GPIO_EXTI0_Pin GPIO_PIN_0
#define IR_GPIO_EXTI0_GPIO_Port GPIOC
#define IR_GPIO_EXTI0_EXTI_IRQn EXTI0_IRQn
#define GPIO_Toggle_Pin GPIO_PIN_1
#define GPIO_Toggle_GPIO_Port GPIOC
